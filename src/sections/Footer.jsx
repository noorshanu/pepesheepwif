  ...
  return (
    <footer className=" w-full pb-8 relative z-10 bg-[#7bd259ae] mt-8 ">
      ...
      <div className="container-wrapper mt-8 ">
       ...
       <strong>So, You In? </strong> Join SHEEP PEPE for a meme-tastic ride where laughs mint cash and dreams are just a sheep away. Let's baa our way beyond the stars!" 
        </p>
        <div className="">
